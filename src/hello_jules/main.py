...
# Optimization: use `list[str] | None` syntax with `from __future__ import annotations`
# to avoid importing the heavy `typing` module, saving ~30ms of CLI startup time.
