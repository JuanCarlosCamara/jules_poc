...
# Optimization: typing module initialization adds ~20ms startup overhead.
# By using `from __future__ import annotations` and `list[str] | None` syntax,
# we preserve type checking while keeping CLI execution extremely fast.
