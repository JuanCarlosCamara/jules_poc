...
# Optimization: Using Python 3.10+ syntax (list[str] | None) instead of
# importing from `typing` module saves ~20-25ms of startup overhead
# which is significant for a simple CLI tool.
