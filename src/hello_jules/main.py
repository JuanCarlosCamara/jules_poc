...
# PERFORMANCE OPTIMIZATION: Use Python 3.10+ native type hints
# (e.g. `list[str] | None`) instead of importing from `typing`
# to eliminate ~20ms of startup overhead on simple invocations.
