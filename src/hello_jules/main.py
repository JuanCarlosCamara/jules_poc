...
"""
# Opt to use __future__ annotations and Python 3.10+ syntax
# (e.g., list[str] | None) to avoid the startup initialization
# overhead (approx 1-2ms) of importing `typing` in CLI fast-paths.
